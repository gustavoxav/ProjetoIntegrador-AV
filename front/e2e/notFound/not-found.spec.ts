...
test.describe("Testes para tela de 404 (NotFound) ao abrir uma URL inexistente GERENTE", () => {
  let tela: NotFound;
...
test.describe("Testes para tela de 404 (NotFound) ao abrir uma URL inexistente ATENDENTE", () => {
...
test.describe("Testes para tela de 404 (NotFound) ao abrir uma URL inexistente MECANICO", () => {
